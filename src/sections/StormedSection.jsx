...
export default function StormedSection() {
  ...
  return (
    <section id="stormed" className="py-24 sm:py-32 lg:py-40 bg-ns-black relative overflow-hidden">
      ...
      <div className="relative container-wide">
        ...
        <div ref={ref} className={`text-center mb-16 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-ns-white leading-tight mb-4 tracking-tight">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-16 max-w-2xl mx-auto">
          {t.stormed.stats.map((stat, i) => (
            <div key={i} className="text-center p-6 bg-ns-card border border-ns-border rounded-xl">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          {/* Left: features list */}
          <div>
            <h3 className="text-xl font-bold text-ns-white mb-6">Funcionalidades Completas</h3>
            <div className="space-y-3 mb-8">
              {t.stormed.features.map((feature, i) => (
                <div key={i} className="flex items-center gap-3 p-3.5 rounded-xl bg-ns-panel/50 border border-ns-border/30 hover:border-ns-accent/20 transition-colors">
          ...
          <div className="relative">
            ...
            <div className="relative bg-ns-card border border-ns-border rounded-2xl overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                  ...
                  <>
                    <div className="grid grid-cols-3 gap-3">
                      {[
                        ...
                        <div key={i} className="bg-ns-panel rounded-xl p-4 border border-ns-border/50">
                    ...
                    <div className="bg-ns-panel rounded-xl p-5 border border-ns-border/50">
                    ...
                    <div className="bg-ns-accent/5 border border-ns-accent/20 rounded-xl p-4">
                      ...
                      <p className="text-xs text-ns-gray leading-relaxed">Substituir fornecedor de Aço SAE 1020 por alternativa com custo 12% menor. Economia projetada: R$15.200/mês.</p>
                    </div>
                  </>
                )}
                ...
                {activeTab === 1 && (
                  <>
                    <div className="border-2 border-dashed border-ns-border rounded-xl p-8 text-center">
                    ...
                    <div className="bg-ns-panel rounded-xl p-5 border border-ns-border/50">
                      ...
                      <div className="space-y-2.5">
                        {[
                          ...
                          <div key={i} className="flex justify-between items-center py-2 border-b border-ns-border/30 last:border-0">
                ...
                {activeTab === 2 && (
                  <>
                    <div className="bg-ns-panel rounded-xl p-5 border border-ns-border/50">
                      ...
                      <div className="space-y-3">
                        {[
                          ...
                          <div key={i} className={`p-3.5 rounded-xl border ${s.status === 'best' ? 'border-ns-accent/30 bg-ns-accent/5' : 'border-ns-border/30 bg-ns-dark/50'}`}>
                    ...
                    <div className="bg-ns-panel rounded-xl p-5 border border-ns-border/50">
                      ...
                      <div className="grid grid-cols-2 gap-3 mt-4">
                        {[
                          ...
                          <div key={i} className="p-3 rounded-xl bg-ns-dark/50 border border-ns-border/20">
                    ...
                    <div className="bg-green-500/5 border border-green-500/20 rounded-xl p-4">
                      ...
                      <p className="text-xs text-ns-gray leading-relaxed">Com base nas 3 recomendações ativas, economia projetada de <span className="text-green-400 font-bold">R$47.800/mês</span> nos próximos 90 dias.</p>
                    </div>
                  </>
                )}
              </div>
