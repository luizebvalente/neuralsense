...
export default function HeroSection() {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center overflow-hidden">
      <ParticleBackground />
      <div className="absolute inset-0 bg-gradient-to-b from-ns-black/60 via-ns-black/40 to-ns-black" />
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-ns-accent/5 rounded-full blur-[120px]" />
      <div className="absolute bottom-1/4 right-1/4 w-72 h-72 bg-blue-600/5 rounded-full blur-[100px]" />

      <div ref={ref} className={`relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <div className="max-w-4xl">
          ...
          <h1 className="font-heading text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-ns-white leading-[1.1] mb-6 tracking-tight">
          ...
          <p className="text-lg sm:text-xl text-ns-gray max-w-2xl leading-relaxed mb-10">
            {t.hero.subtitle}
          </p>
          ...
          <div className="flex items-center gap-8 mt-12 pt-8 border-t border-ns-border/50">
            {[
              ...
              <div key={i} className="text-center sm:text-left">
                ...
                <p className="text-xs text-ns-muted mt-0.5">{stat.label}</p>
              </div>
            ))}
          </div>
        </div>
